# Goo Gooey Section Demo Prompts

## Minimal prompt

Use $gooey-section-goo to add the goo gooey edge between the sections of this page.

## Recreate the demo

Use $gooey-section-goo to build a standalone reference demo for this feel:

> A tight, sticky pull whose flanks sink slightly before rejoining the flat line.
...
- Six full-height sections alternating cream #F1F4EE and dark #161B17, starting with a cream hero titled "Goo".
...
- Load the skill's engine unchanged from ../assets/gooey-section.js and start it with `GooeyEdge.init({ variant: 'goo' })`.
