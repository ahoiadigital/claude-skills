# Peel Gooey Section Demo Prompts

## Minimal prompt

Use $gooey-section-peel to add the peel gooey edge between the sections of this page.

## Recreate the demo

Use $gooey-section-peel to build a standalone reference demo for this feel:

> It drains fast from full stretch, then the last of it peels off slowly.
...
- Six full-height sections alternating cream #F1F4EE and dark #161B17, starting with a cream hero titled "Peel".
...
- Load the skill's engine unchanged from ../assets/gooey-section.js and start it with `GooeyEdge.init({ variant: 'peel' })`.
